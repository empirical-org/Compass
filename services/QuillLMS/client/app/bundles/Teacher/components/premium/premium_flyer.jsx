      ...
      <div className="premium-flyer">
        <div className="inner-premium-flyer">
          <div className="content">
            ...
            <a className="download-button" download="Quill Premium" href="https://assets.quill.org/documents/quill_premium_updated.pdf"><i className="fas fa-file-pdf" />Download Premium PDF</a>
          </div>
          <div className="picture">
            <img src={`${process.env.CDN_URL}/images/shared/big_premium_flyer.png`} />
          </div>
        </div>
      </div>
    );
